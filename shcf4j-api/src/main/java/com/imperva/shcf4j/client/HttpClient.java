...
public interface HttpClient extends Closeable{
     ...
     * associated with the response is fully consumed and the underlying
     * connection is released back to the connection manager automatically
     * in all cases relieving individual {@link ResponseHandlerBase}s from
     * having to manage resource de allocation internally.
     *
     * @param target  the target host for the request.
     * @param request the request to execute
     ...
     * @return the response object as generated by the response handler.
     * @throws IOException in case of a problem or the connection was aborted
     * @deprecated use ResponseHandler instead of ResponseHandlerBase
     */
    @Deprecated
    <T> T execute(HttpHost target, HttpRequest request, ResponseHandlerBase<? extends T> handler) throws IOException;
     ...
     */
    @Deprecated
    <T> T execute(HttpHost target, HttpRequest request, ResponseHandlerBase<? extends T> handler, ClientContext ctx) throws IOException;
